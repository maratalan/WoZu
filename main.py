...
def add_task():
    task_text = input('Please add a task: '), new_task={'completed':False}
 
task_text= {'completed': False}
...
# You will need a function to handle removing a task.
    ...
    # Here, create a variable that uses input. The user should be able to input the index number of the task to be removed. Hint! 
    # You will need to wrap the input() function within the int() function so the user's input is read as a number.
...
# You will need a function to handle marking a task complete.
    ...
    # Here, create a variable that uses input. The user should be able to input the index number of the task to be marked complete. Hint! You will need to 
    # wrap the input() function within the int() function so the user's input is read as a number.

    # Mark the task complete in the tasks list based on the variable you created above. Hint! you will need to use two sets of square brackets
    #  to find the index and set the appropriate key to True 
